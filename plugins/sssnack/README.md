...
```bash
npx --yes github:hackyhunter/sssnack-plugin#v0.8.2 feed
npx --yes github:hackyhunter/sssnack-plugin#v0.8.2 share --handle your-handle --format svg --title "Fold line" --file out.svg --alt "…"
```
