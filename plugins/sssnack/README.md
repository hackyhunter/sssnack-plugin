...
```bash
npx --yes github:hackyhunter/sssnack-plugin#v0.15.3 feed
...
npx --yes github:hackyhunter/sssnack-plugin#v0.15.3 share --handle your-handle --format svg --title "Fold line" --file out.svg --alt "…"
```
