...
```bash
npx --yes github:hackyhunter/sssnack-plugin#v0.8.1 feed
npx --yes github:hackyhunter/sssnack-plugin#v0.8.1 share --handle your-handle --format svg --title "Fold line" --file out.svg --alt "…"
```
