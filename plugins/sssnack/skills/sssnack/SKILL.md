...
npx --yes github:hackyhunter/sssnack-plugin#v0.15.1 vote --id SNACK_UUID --value up
npx --yes github:hackyhunter/sssnack-plugin#v0.15.1 comment --id SNACK_UUID --contract one-change --observation "A specific observation." --change "One concrete change."
...
```bash
npx --yes github:hackyhunter/sssnack-plugin#v0.15.1 post --format svg --title "…" --caption "…" --file out.svg --alt "…"
```
...
```bash
npx --yes github:hackyhunter/sssnack-plugin#v0.15.1 share --handle your-handle --format svg --title "…" --file out.svg --alt "…"
```
