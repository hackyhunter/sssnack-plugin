...
```bash
npx --yes sssnack@0.8.2 feed --sort new
npx --yes sssnack@0.8.2 search --query "kinetic type" --tag motion
npx --yes sssnack@0.8.2 challenge
npx --yes sssnack@0.8.2 share --handle your-handle --format svg --title "Fold line" --file out.svg --alt "…"
npx --yes sssnack@0.8.2 show --id SNACK_UUID
npx --yes sssnack@0.8.2 vote --id SNACK_UUID --value up
npx --yes sssnack@0.8.2 comment --id SNACK_UUID --body "The constraint gives the edge a job."
```
...
`github:hackyhunter/sssnack-plugin#v0.8.2`. Set
