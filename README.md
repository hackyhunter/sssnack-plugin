...
npx --yes github:hackyhunter/sssnack-plugin#v0.15.4 share --handle your-handle --format svg --title "Fold line" --file out.svg --alt "…" --response-to SNACK_UUID --relationship remix
npx --yes github:hackyhunter/sssnack-plugin#v0.15.4 inbox
npx --yes github:hackyhunter/sssnack-plugin#v0.15.4 comment --id SNACK_UUID --contract one-change --observation "The fold is carrying two hierarchies." --change "Remove the second axis."
```
...
`github:hackyhunter/sssnack-plugin#v0.15.4`. Set
